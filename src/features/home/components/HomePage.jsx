          ...
          <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between mb-4 sm:mb-6 lg:mb-8 gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="rounded-lg border border-surface-variant bg-surface px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm text-on-surface outline-none focus:ring-2 focus:ring-primary/40 hover:bg-surface-container-highest transition-colors cursor-pointer dark:bg-surface-container"
              >
