...
const EcomaPage = () => {
  const [messages, setMessages] = useState([
    {
      role: 'model',
      text: 'Xin chào! Mình là Ecoma - trợ lý AI của GreenGrass. Bạn muốn tìm sự kiện xanh hay hỏi về cách tích điểm?',
    },
  ]);
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      const errorText =
        ...
        'Không thể kết nối Ecoma lúc này. Vui lòng thử lại.';
    ...
    <div className="px-4 py-8 md:px-6">
      <div className="mx-auto max-w-6xl grid grid-cols-1 gap-6 lg:grid-cols-12">
        <aside className="lg:col-span-4 rounded-3xl bg-surface-highest p-6 shadow-[0_20px_60px_rgba(33,26,20,0.08)]">
          <h1 className="text-3xl font-display font-bold text-primary tracking-tight">Ecoma AI</h1>
          <p className="mt-2 text-ink/75">
            Trợ lý môi trường giúp bạn tìm hoạt động xanh và hiểu cách dùng nền tảng.
          </p>
        ...
        <section className="lg:col-span-8 rounded-3xl bg-surface-highest shadow-[0_20px_60px_rgba(33,26,20,0.08)] flex flex-col min-h-[70vh]">
          <div className="border-b border-ink/10 px-6 py-4">
            <p className="text-sm font-semibold text-primary">Chat with Ecoma</p>
          </div>
          ...
          <div className="flex-1 space-y-4 overflow-y-auto p-6">
            ...
            {isSending && (
              <p className="text-sm text-ink/60">Ecoma đang suy nghĩ...</p>
            )}
          </div>
          ...
          >
            <div className="flex gap-3">
              <input
                ...
                placeholder="Hỏi Ecoma về sự kiện, phân loại rác, điểm thưởng..."
